...
Ranks = {
	{5,	"Owner",		};
	{4,	"HeadAdmin",	{"Diamonddaichan",0},	};
	{3,	"Admin",		{"MisterSparkz",0},	};
	{2,	"Mod",			{"ultrabeast2929","Asuna_zodiac",0},	};
	{1,	"VIP",			{"bunnycupcake339","Disneyxime114",0},	};
	{0,	"NonAdmin",		};
};
...
Theme				= "Gray";		-- The default UI theme.
